...
const EVENTS_DATA: Event[] = [
  ...
  },
  {
    ...
    rules: [
      "Participants: 8+3",
      "Classes: 8-12",
      "Duration: 6+2 minutes (including setup time)",
  ...
  },
  {
    ...
    rules: [
      "Participants: 6+4",
      "Classes: 8-12",
      "Duration: 12+3 min (including setup time)",
      "There will be three categories in the event:",
  ...
  },
  {
    ...
    rules: [
      "Participants: 3 + 1 (Reserve)",
      "Classes: 9-12",
      "Duration: 120 minutes",
      "Only Hindi songs will be allowed.",
      "Singing songs containing vulgar lyrics will lead to disqualification.",
      "There will be an elimination round consisting of three rounds, and the top 8 teams shall be selected for the next level.",
      ...
      "All participating schools are informed that there will be a retro round from the 1960s onwards."
    ]
  },
  {
    id: "western-music",
    ...
    rules: [
      "Participants: 6+4",
      "Classes: 8-12",
      "Duration: 10+3 minutes (including setup time)",
  ...
  },
  {
    ...
    rules: [
      "Participants: 7+3",
      "Classes: 6 - 12",
      "Duration: 10 minutes (Empty stage to empty stage)",
      "The performance must include at least one of the following dance forms:",
      "  1. Bharatnatyam",
      "  2. Kathak",
      "  3. Semi-Classical",
      "  4. Kathakali",
  ...
  },
  {
    ...
    rules: [
      ...
      "• Participants will be given 5 minutes to analyse the problem.",
      "• The block of code provided will contain a few syntax/logical/runtime errors which the participants will have to identify.",
  ...
  },
  {
    ...
    rules: [
      ...
      "• The game will take place in an area filled with obstacles. If the runner evades capture for the entirety of the round, they are declared the winner for that round. If they are captured before the time limit, points will be awarded based on the time for which they are able to evade capture.",
      ...
      "ROUND 2 & 3: Unconventional Games",
      "• The rules for this round will be declared on the day of the event itself.",
      "• Note: Points will be calculated cumulatively for each team. The team with maximum points at the end of all 3 rounds shall win."
    ]
  },
  {
    id: "pickleball",
    ...
    rules: [
      "Classes: 9-12 (There shall be separate draws for girls and boys.)",
      "Category: Doubles (2 players per team)",
      "Entries per School:",
      ...
      "EVENT FORMAT:",
      "• Preliminary Rounds: Knockout Match. Length: First to 7 points win by 2.",
      "• Semi-Finals: Length: First to 11 points, win by 2.",
      "• Finals: Format: Best of 3 sets. Switch Sides: Teams switch sides at the end of each set. Each Set: Played to 11 points, win by 2.",
      "CODE OF CONDUCT:",
      ...
      "• Indoor pickleballs will be provided.",
      "• All matches will be conducted in accordance with the official rules of USA Pickleball.",
      "• Note to Participants: Participants must report at least 15 minutes before the scheduled match or round. Carry personal water bottles and towels. A schedule of matches/rounds will be released prior to the event day. Players are to carry their own personal paddles."
    ]
  },
  {
    ...
    rules: [
      ...
      "The faintest hint of aggression, or the use of unparliamentary language, either towards the opponent or the teachers/organisers of the games shall lead to immediate disqualification of the team.",
      "It shall be considered as a failure:",
  ...
  },
  {
    ...
    rules: [
      ...
      "Duration: 120 minutes",
      "Classes: 9-12",
      "NO MATERIALS will be provided by the host School.",
      "List of materials to be brought by the Participants:",
      ...
      "• Participants must bring their own materials required for their item. ITEMS NOT PERMITTED: SUPERGLUE (Fevi kwik), GLUE GUNS and MANNEQUINS.",
  ...
  },
  {
    ...
    rules: [
      "Participants: 2 per category",
      "Duration: 120 minutes",
      "The event is divided into two categories, schools can participate in one or both categories.",
      "SENIORS (Classes: 9-12):",
      "One participant will draw and paint on the topic on the Canvas.",
      "The other participant will create a visual logo and a slogan on an A3 size paper which will impart a strong message on the theme.",
      "Rules:",
      "  - Participants MUST submit a hard copy mentioning items being used to the judges on the day of the event.",
      "  - The paintings MUST correlate with the theme.",
      "  - The participants must carry the following items: Boards for mounting A3 size paper for slogan writing, Acrylic Paints (Non-Toxic), Markers, Colour Pencils, Paintbrushes, Toothbrush, Palette, Cotton Cleaning Cloth.",
      ...
      "  - Participants must take back all unused materials. Littering is strictly prohibited.",
      "  - Both participants must actively participate for the entire duration.",
      "  - A bell will ring at the end of 120 minutes and all participants MUST stop.",
      "  - Judges will question the participants on their artwork and relevance (Time: 3+2 minutes).",
      "  - The judges' decision will be final and binding. The final artwork will be retained by the host school.",
      "JUNIORS (Classes: 6-8):",
      "One participant will do sketching and pencil shading on the topic on an A3 size paper.",
      "The other participant will write a slogan on A3 size paper which will impart a strong message on the theme.",
      "Rules:",
      "  - There will be 2 participants for this category.",
      "  - The paintings MUST correlate with the theme.",
      "  - The participants must carry the following items: Boards for mounting A3 size paper for slogan writing, Shading pencils, erasers, etc., Markers for slogan, Cotton Cleaning Cloth.",
      "  - Only Two sheets of A3 size paper will be provided by the host school.",
      "  - Any sort of tracing or duplicating will lead to immediate disqualification.",
      "  - Any kind of vulgarity depicted through the artwork will lead to immediate disqualification.",
      "  - Participants must clean their workstation and take back unused materials. Littering is strictly prohibited.",
      "  - Both participants must actively participate for the entire duration.",
      "  - A bell will ring at the end of 120 minutes and all participants MUST stop.",
      "  - Judges will question the participants on their artwork and relevance (Time: 3+2 minutes).",
      "  - The judges' decision will be final and binding. Littering the campus is strictly prohibited.",
  ...
  },
  {
    ...
    rules: [
      ...
      "Poems must be divided into stanzas of 4 lines each.",
  ...
  },
  {
    ...
    rules: [
      "Participants: 3+2",
      "Classes: 9-12",
      "ROUND 1 - The Suggestion Box",
      "• Time limit: 1 minute 30 seconds + 30 seconds",
      ...
      "• Teams are required to enact a scene from any short film, movie, documentary, video, story, novel, or any source of media and entertainment; with their own take on it, in essence, turning the original scene into a brand new one and giving a different perspective to the original scene.",
      "• Rules for the round:",
      "  - Teams are required to submit a transcript of the original scene and along with it a script of their own take on it by 5th July, 2026.",
      ...
      "ROUND 3 - Genre Mashup",
      "• Time limit: 30+30+30 seconds",
  ...
  },
  {
    ...
    rules: [
      "Participants: 4",
      "Duration: 60 seconds per round (for each team)",
      "Classes: 9-12",
      "Number of Rounds: 2",
      "GENERAL RULES:",
      ...
      "• In the event of a tie at the conclusion of both the rounds, a sudden-death round may be conducted.",
  ...
  },
  {
    ...
    rules: [
      ...
      "  - Assistant/Support (Not Judged)",
      "Time Limit: 60 seconds",
      "Classes: 9-12",
      "Maximum Entries per School: 1 (Only one participant will be judged)",
      "RULES & REGULATIONS:",
      "Originality & Creativity:",
      "• The act must be entirely original and created by the participant(s).",
      "• Copying well-known routines, copyrighted content, or viral acts will negatively impact scoring.",
      "Type of Performance Allowed:",
      "• The event is open-ended, meaning participants may choose from a wide range of non-violent, non-obscene talents. Acceptable acts include but are not limited to:",
      "  - Miming",
      "  - Mimicry",
      ...
      "  - Magic tricks",
      "  - Ventriloquism",
      "  - Instrumental solos (non-amplified instruments allowed only if volume permits)",
      "• Note: The act must conform to the ethics and safety standards set below.",
      ...
      "• No promotion of violence, hate speech, discrimination, or political opinions.",
      "• Any violation will result in instant disqualification.",
      "• The act must not be meant to disrespect someone.",
      "Time Limit & Stage Protocol:",
  ...
  },
  {
    ...
    rules: [
      ...
      "ROUND I – The Fairy Tale Flip",
      "• Theme: Remaking of Fairy Tales from Around the World",
      "• Participants must creatively reinterpret, modernise, parody, or reimagine famous fairy tales from different cultures and countries. Teams may adapt classic stories by changing the setting, perspective, ending, time period, or underlying message while retaining recognisable elements of the original tale.",
      "• Possible approaches:",
      ...
      "  - Fairy tales placed in contemporary society",
      "• Examples:",
      ...
      "  - An Indian adaptation of a European fairy tale",
      "• Schools may choose fairy tales from any country or culture, provided the adaptation remains appropriate for school performance.",
      "• Script Submission:",
      "  - Soft copy email deadline: 5th July, 2026 to home.boscofest@gmail.com",
      "  - Hard copy to be submitted at registration on fest day.",
      "• Time Limit:",
      "  - Performance: 8 minutes",
      "  - Grace period: 2 minutes",
      "  - Negative marking for exceeding time limit",
      "ROUND II – THINK • TWIST • THEATRE",
      "• Objective: Spontaneity, creativity, wit, and storytelling abilities through themed improvisation.",
      "• Format:",
      ...
      "  - The performance should present a clear and coherent narrative.",
      "• Duration:",
      "  - Preparation Time: 30 seconds",
      "  - Performance Time: 2 minutes + 1 minute grace period",
      "• Participants:",
      "  - 2 members from each qualifying school will participate (selected from Round I performers).",
      "  - Teams will receive 30 seconds to organise their plot before performing immediately.",
      "• Rules & Restrictions:",
      "  - No pre-written scripts or external assistance (including the internet) allowed.",
      ...
      "  - Spontaneity, teamwork, and effective execution will be key in evaluation."
    ]
  },
  {
    id: "non-fire-cooking",
    ...
    rules: [
      ...
      "Duration: 1hr (including preparation and presentation)",
      "Classes: 6-8",
  ...
  },
  {
    ...
    rules: [
      ...
      "• If a team finishes within the time limit, but the grid is incorrectly solved, they shall be disqualified.",
      "• If enough teams do not qualify within the time limit, the qualifications will be decided based on the accuracy of each team.",
      "Format:",
      "• The event will be divided into 3 rounds. The scores in each round will be calculated based on the time taken to solve the puzzle.",
      "• In Round 1, the teams will be given a 6x6 sudoku grid. The time limit shall be 10 minutes.",
      "• In Round 2, the teams will be given a 9x9 sudoku grid. The time limit shall be 15 minutes.",
      "• In Round 3, the teams will be given a 12x12 sudoku grid. The time limit shall be 20 minutes."
    ]
  },
  {
    id: "quiz",
    ...
    rules: [
      ...
      "The reserve can be substituted after an elimination round (Prelims/Round 1). Note that this change can only be made once throughout the duration of the quiz.",
      "For written rounds – Tie breakers will be decided on the following bases, in decreasing order of weight: Starred Questions, Longest continuous streak of correct answers, first correct question, and scores of previous rounds.",
      ...
      "• Round 2 (Written): Audio Visual round. The top 9 teams will qualify for Round 3. No negative marking for incorrect answers.",
      "• Round 3: Long Connect Round. Seating order determined on the basis of Round 2 results in reverse order. Points based on the earliness of answers. Answers are to be disclosed privately to the quizmaster. Negative marking for incorrect answers. No elimination after Round 3.",
  ...
  },
  {
    ...
    rules: [
      ...
      "Classes: 6-8",
      "Format:",
      "• The event will be conducted in 3 rounds, in which each participant will go up against another competitor chosen by a draw of chits.",
      "• Each game will consist of 15 turns per player.",
      "• In each turn, the player will be given one minute to form a word using the scrabble tiles provided.",
      ...
      "• At the end of each game, the scores of every player will be noted, after which they will be paired with another competitor for the next game until each player has played 3 games.",
      "• The awards will be decided by the total cumulative points at the end of the 3 games.",
      "Rules:",
  ...
  },
  {
    ...
    rules: [
      "Participants: 2 (Teams of 1 Participant each.)",
      "Classes: 9-12",
  ...
  },
  {
    ...
    rules: [
      ...
      "Teams must give what they think is the least popular answer as per the survey. They will get the same number of points as the number of people who had given the same answer in the survey. The goal is to give an answer which has been given by the least number of people, thus earning them the least number of points. The teams with the lowest points shall qualify from each round.",
      "For example,",
      "  - The question is “Names of countries starting with the letter R”.",
      "  - Team A answers “Russia”. Similarly, 30 people had answered Russia in the survey. So, Team A gets 30 points.",
      "  - Team B answers “Romania”. If 5 people had answered Romania in the survey, Team B gets 5 points.",
      "  - Team C answers “Rwanda”. If no person had answered Rwanda in the survey, Team C gets zero points (pointless).",
      "  - Team D answers “India”. Since India does not belong to the list of countries starting with the letter R, therefore, the team shall be awarded the maximum points allotted for the question as a penalty.",
